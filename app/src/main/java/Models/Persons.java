...
public class Persons {
    ...
    public static String tableNameLocal = "personslocal";
    ...
    public static ArrayList<StructPerson> all(boolean onlyFriends) {
        ...
        if (!onlyFriends) {
            ...
            cursor = App.DB.rawQuery("SELECT * FROM \"" + tableName + "\" WHERE (\"featured\"=1)" , null);
        }
...
//        cv.put("featured", 1 );
//        return App.DB.update(tableName, cv,  "\"id\"=?", new String[]{"" + id}) > 0;
//    }
//
